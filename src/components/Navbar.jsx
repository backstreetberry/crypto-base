		...
		<div className="rounded-div flex items-center justify-between h-20 font-bold">
			<div className="ml-4 flex items-center">
				<img
					...
					src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8OJjjfB1MDpgzW-dr-Ov5z_BjwQIsReBs9d5R8P8karfYMUWTCNSQUC9lZZGTM9F7l-A&usqp=CAU"
					alt="/"
				/>
				<Link to="/">
					<h1 className="text-2xl px-4">CryptoBase</h1>
				</Link>
			</div>
			...
			{user?.email ? (
				...
				<div className="hidden md:block">
					...
					<Link
						to="/signup"
						className="bg-button text-btnText px-5 py-2 ml-2 mr-4 rounded-2xl shadow-lg hover:shadow-2xl"
					>
						Sign Up
					</Link>
				</div>
